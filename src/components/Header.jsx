    ...
    <header className="flex items-center justify-between px-6 py-3 glass-card mb-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[10px] text-gray-500 tracking-wide uppercase">Adaptive Resource Scarcity Simulator</p>
        </div>
      </div>

      {/* Center: Cycle Counter */}
      <div className="text-center px-6 py-2 rounded-xl bg-white/5 border border-white/10">
        <span className="text-[10px] text-gray-400 uppercase tracking-widest font-medium">Cycle</span>
